...
Note: If you do not want to specify the hour and minute for the repeat time, use the abbreviated 3-segment format. For a detailed discussion, see the later section on [[Core Properties]].
** Core Properties
